<%@ page language="java" contentType="text/html; charset=UTF-8"
  ...
  <%@taglib uri="http://java.sun.com/jstl/core_rt" prefix="c"%>
	<%@taglib uri="http://java.sun.com/jstl/fmt_rt" prefix="fmt"%>
 			...
 			<c:url var="url" value="/kgbBookstore.com/admin/tac-gia/form" />
...
<body>
	...
	<form:form class="row" action="${url}" method="post" modelAttribute="tacGia">
		  <div class="row">
		  ...
		  <div class="form-group">
		    <form:label path="ten" >Tên tác giả</form:label>
		      <form:input path="ten" type="text" class="form-control" placeholder="Tên tác giả"/>
